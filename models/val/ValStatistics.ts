...
export class ValStatistics {
    ...
    matchStatisticsByAgent: ValMatchStatistics[] = []; // Ordered from most played to least played agent
    matchStatisticsByFriend: ValMatchStatistics[] = []; // Ordered from most played with to least played with friend
    ...
    calculateStatistics(mapIdFilterSet: Set<string> | null = null, queueIdFilterSet: Set<string> | null = null, versionFilterSet: Set<string> | null = null, seasonFilterSet: Set<string> | null = null) {
        ...
        for(let match of this.matches) {
            ...
            this.aggregatedStatistics = this.aggregatedStatistics.aggregateStatistics(matchStatistics);
        ...
        this.aggregatedStatistics.agentsPlayed.forEach((value, key) => {
            ...
            matchStatisticsByAgent.push(agentMatchStatistics);
        });
        ...
        this.aggregatedStatistics.friendsPlayedWith.forEach((value, key) => {
            ...
            matchStatisticsByFriend.push(friendMatchStatistics);
        });
