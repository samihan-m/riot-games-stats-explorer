// Taken from https://github.com/bcho04/galeforce/blob/master/src/galeforce/interfaces/dto/riot-api/val-match-v1/match.ts
// Thanks a billion

export interface ValMatchData extends ValMatchDTO {}; // Aliasing for convenience
...
interface MatchInfoDTO {
    ...
    gameVersion: string; // Added this one myself because it's not in the DTO
